...
struct AddTrainViewModelTests {
  ...
  let mockTrains = [
    ProjectedTrain(
      ...
      position: Position(latitude: -6.5, longitude: 107.0),
      moving: true,
      bearing: 45,
      routeIdentifier: "R1",
      speedKph: 80,
    ...
    ProjectedTrain(
      ...
      position: Position(latitude: -7.0, longitude: 108.0),
      moving: true,
      bearing: 90,
      routeIdentifier: "R1",
      speedKph: 70,
  ...
  func testBootstrap() {
    ...
    #expect(viewModel.availableTrains.count == mockTrains.count)
  }
  ...
  func testMultipleBootstrap() {
    ...
    viewModel.bootstrap(availableTrains: [], allStations: newStations)
