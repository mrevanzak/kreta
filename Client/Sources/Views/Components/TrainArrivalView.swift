...
struct PulsatingArcShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 37.2905 * scaleX, y: 526.093 * scaleY),
        ...
        path.addCurve(to: CGPoint(x: 47.6843 * scaleX, y: -128.25 * scaleY),
        ...
        path.addCurve(to: CGPoint(x: 504.525 * scaleX, y: 434.578 * scaleY),
...
#Preview {
    TrainArrivalView(stationCode: "SLO", stationName: "Solo Balapan") { }
}
